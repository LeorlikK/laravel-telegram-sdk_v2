 ...
 *
 * Cache:
 * >>> ✔️ при удалении роли, удалить ключи пользователей, чья роль попадает под удаление
 * >>> ✔️ после покупки у пользователя сохраняется стейт в кэше - нужно сохранять без него
 * >>> при удалении из продукта нужно что-то придумать с ключами продуктов в кэше
 * >>> ✔️ при добавлении в корзину нужно что-то придумать с ключами продуктов в кэше
 * >>> ✔️ при удалении из корзины нужно что-то придумать с ключами продуктов в кэше
 *
 * кэширование роли?
